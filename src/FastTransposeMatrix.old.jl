...
export transpose2x2!
function transpose2x2!(B::AbstractMatrix{T}, A::AbstractMatrix{T}) where {T}
    @assert size(A) == (2, 2)
    @assert size(B) == (2, 2)
    @assert stride(A, 1) == 1
    @assert stride(B, 1) == 1
    ...
    @inbounds begin
        a0 = vloada(Vec{2,T}, view(A, :, 1), 1)
        a1 = vloada(Vec{2,T}, view(A, :, 2), 1)
...
export transpose4x4!
function transpose4x4!(B::AbstractMatrix{T}, A::AbstractMatrix{T}) where {T}
    @assert size(A) == (4, 4)
    @assert size(B) == (4, 4)
    @assert stride(A, 1) == 1
    @assert stride(B, 1) == 1
    ...
    @inbounds begin
        a0 = vloada(Vec{4,T}, view(A, :, 1), 1)
        a1 = vloada(Vec{4,T}, view(A, :, 2), 1)
        a2 = vloada(Vec{4,T}, view(A, :, 3), 1)
        a3 = vloada(Vec{4,T}, view(A, :, 4), 1)
...
export transpose8x8!
function transpose8x8!(B::AbstractMatrix{T}, A::AbstractMatrix{T}) where {T}
    @assert size(A) == (8, 8)
    @assert size(B) == (8, 8)
    @assert stride(A, 1) == 1
    @assert stride(B, 1) == 1
    ...
    @inbounds begin
        a0 = vloada(Vec{8,T}, view(A, :, 0x0 + 0x1), 0x1)
        a1 = vloada(Vec{8,T}, view(A, :, 0x1 + 0x1), 0x1)
        a2 = vloada(Vec{8,T}, view(A, :, 0x2 + 0x1), 0x1)
        a3 = vloada(Vec{8,T}, view(A, :, 0x3 + 0x1), 0x1)
        a4 = vloada(Vec{8,T}, view(A, :, 0x4 + 0x1), 0x1)
        a5 = vloada(Vec{8,T}, view(A, :, 0x5 + 0x1), 0x1)
        a6 = vloada(Vec{8,T}, view(A, :, 0x6 + 0x1), 0x1)
        a7 = vloada(Vec{8,T}, view(A, :, 0x7 + 0x1), 0x1)
...
function transpose16x16!(B::AbstractMatrix{T}, A::AbstractMatrix{T}) where {T}
    @assert size(A) == (16, 16)
    @assert size(B) == (16, 16)
    @assert stride(A, 1) == 1
    @assert stride(B, 1) == 1
    ...
    @inbounds begin
        a0 = vloada(Vec{16,T}, view(A, :, 0x0 + 0x1), 0x1)
        a1 = vloada(Vec{16,T}, view(A, :, 0x1 + 0x1), 0x1)
        a2 = vloada(Vec{16,T}, view(A, :, 0x2 + 0x1), 0x1)
        a3 = vloada(Vec{16,T}, view(A, :, 0x3 + 0x1), 0x1)
        a4 = vloada(Vec{16,T}, view(A, :, 0x4 + 0x1), 0x1)
        a5 = vloada(Vec{16,T}, view(A, :, 0x5 + 0x1), 0x1)
        a6 = vloada(Vec{16,T}, view(A, :, 0x6 + 0x1), 0x1)
        a7 = vloada(Vec{16,T}, view(A, :, 0x7 + 0x1), 0x1)
        a8 = vloada(Vec{16,T}, view(A, :, 0x8 + 0x1), 0x1)
        a9 = vloada(Vec{16,T}, view(A, :, 0x9 + 0x1), 0x1)
        aa = vloada(Vec{16,T}, view(A, :, 0xa + 0x1), 0x1)
        ab = vloada(Vec{16,T}, view(A, :, 0xb + 0x1), 0x1)
        ac = vloada(Vec{16,T}, view(A, :, 0xc + 0x1), 0x1)
        ad = vloada(Vec{16,T}, view(A, :, 0xd + 0x1), 0x1)
        ae = vloada(Vec{16,T}, view(A, :, 0xe + 0x1), 0x1)
        af = vloada(Vec{16,T}, view(A, :, 0xf + 0x1), 0x1)
